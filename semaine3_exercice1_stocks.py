...
# Utiliser des if pour incrementer les compteurs
...
# --- AFFICHAGE RAPPORT ---
# S2 (reutilise) : f-strings structures
...
print(f' Stocks normaux : {nb_stock_normal}')
print('=' * 65)

# Alerte prioritaire conditionnelle (S3)
if nb_ruptures_critiques > 0:
    print('!! ALERTE PRIORITAIRE :', nb_ruptures_critiques, 'medicament(s) en RUPTURE CRITIQUE !!')
